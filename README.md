...
fetched from a pinned engine release (v0.3.0) and sha256-verified. Its
...
| `test/golden.cpp` | The golden-suite port — replays the engine's 267-line fixture suite (v0.3.0's, including the map-keys and phrase ops) against the downloaded libcorvid |
...
And the v0.3.0 direct positional search (`examples/text_search.cpp`):
